...
- 数据为**东京 23 区全量**（1,206,772 条边，含此前缺失的台東/北/板橋/荒川/足立/葛飾等区），**阴影已接入**（PLATEAU 2020 **v3.2**，671 mesh 全覆盖，09:00/12:00/15:00 三时段阴影感知路由与图层可用）；
...
| 阴影图层/阴影感知路由 | 已可用（PLATEAU 2020 v3.2 三时段）；阴影数据源版本为 v3.2（官方 CKAN S3 镜像），比管线原计划的 v4.2 版次略旧但同为官方 2020 数据 |
